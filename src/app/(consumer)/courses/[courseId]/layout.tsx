...
import { wherePublicLessons } from "@/features/lessons/permissions";
...
export default function CoursePageLayout(
  props: LayoutProps<"/courses/[courseId]">
) {
  return (
    <AsyncBoundary>
      <CoursePageLayoutContent {...props} />
    </AsyncBoundary>
  );
}

async function CoursePageLayoutContent({
  params,
  children,
...
async function SuspenseBoundary({
  ...
  const completedLessonIds =
    user == null ? [] : await getCompletedLessonIds(user.id);
